      ...
      <div className="container mx-auto p-4 flex h-screen bg-gray-100">
        ...
        <div className="w-1/2 p-2 flex items-start justify-start py-48">
          <div className="bg-gray-100 p-4">
            ...
            <h1 className="text-start font-body text-gray-600 py-6 text-sm"> Already have an account? <a href="/login" className="text-start font-body text-blue-500 py-4 text-sm"> Log in here!</a></h1>
