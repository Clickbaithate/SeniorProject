...
const MovieCard = ({movie, theme, index}) => {
  ...
  return (
    <div key={index} onClick={() => handleOnClick(movie.title)} className="transition-all ease-in-out duration-500 transform hover:scale-110 min-w-[175px] max-w-[175px] bg-transparent flex-shrink-0 cursor-pointer ">
