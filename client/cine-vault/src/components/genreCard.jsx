...
const GenreCard = ({ genre, theme, index }) => {
  ...
  return (
    <div onClick={() => handleClick(genre.name)} className={`hover:bg-gray-900 min-w-48 h-24 flex items-center justify-center p-4 rounded-2xl cursor-pointer shadow-[rgba(0,0,15,0.5)_10px_5px_4px_0px] ${theme === "light" ? "bg-[#E4E4E4]" : "bg-[#25262F]"}`}>
